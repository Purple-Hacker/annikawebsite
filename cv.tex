...
\begin{header}
    ...
    \begin{onecolentry}
        PhD student at ETH Zurich in two departments, Physics and Earth \& Planetary Sciences. Currently modeling carbon and sulfur cycles on temperate super-Earths and sub-Neptunes; generally interested in simulations, missions, and dynamics.
    \end{onecolentry}
